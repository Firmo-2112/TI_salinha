    ...
    load() {
        ...
        if (AppState.snippets.length === 0) {
            AppState.snippets = [
                ...
                { id: '2', title: 'Verificar Integridade do Sistema', categoria: 'sistema', tipo: 'cmd', tags: 'sistema, reparo, sfc', descricao: 'Verifica e repara arquivos do sistema Windows', codigo: 'sfc /scannow' },
                { id: '3', title: 'Listar Processos', categoria: 'sistema', tipo: 'powershell', tags: 'processos, sistema', descricao: 'Lista processos em execução ordenados por memória', codigo: 'Get-Process | Sort-Object WS -Descending | Select-Object -First 10 Name, Id, WS, CPU' },
                { id: '4', title: 'Resetar Configurações de Rede', categoria: 'rede', tipo: 'batch', tags: 'rede, reset, tcp', descricao: 'Script para resetar configurações de rede', codigo: '@echo off\nipconfig /release\nipconfig /renew\nipconfig /flushdns\nnetsh winsock reset\nnetsh int ip reset\necho Concluido!\npause' },
                { id: '5', title: 'Verificar Espaço em Disco', categoria: 'sistema', tipo: 'cmd', tags: 'disco, espaço', descricao: 'Mostra espaço disponível em disco', codigo: 'wmic logicaldisk get size,freespace,caption' }
            ];
        }
